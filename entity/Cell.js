...
Cell.prototype.pID = function() {
if (this.owner) {
        return this.owner.pID;
    } else {
        return "";
    }
};
Cell.prototype.getClan_id = function() {
if (this.owner) {
        return this.owner.clan_id;
    } else {
        return "";
    }
};
Cell.prototype.teamcode = function() {
if (this.owner) {
        return this.owner.teamcode;
    } else {
        return "";
    }
};
